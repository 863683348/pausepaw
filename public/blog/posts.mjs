...
<p>Start with the data. Record a week using the method on the <a href="/blog.html">blog</a>, then look at the focus tools on the <a href="/">home page</a>.</p>`,
  ...
  },
  {
    ...
    date: "2026-09-19",
    en: {
      title: "Netflix Autoplay: The Hidden Screen Time Killer",
      desc: "Netflix autoplay keeps you watching without you realizing it. Here is how to turn it off.",
      body: "<p>Netflix autoplay is the feature that decides when your viewing session ends.</p><h2>How autoplay works</h2><p>When an episode ends, Netflix automatically starts the next one.</p><h2>Why it is hard to stop</h2><ul><li>No natural pause</li><li>Preview syndrome</li><li>Commitment bias</li></ul><h2>How to turn it off</h2><p>Go to Account → Profile & Parental Controls → Playback Settings → Autoplay Next Episode → Turn off.</p><h2>FAQ</h2><ul><li>Will turning off autoplay ruin the experience? No.</li><li>Does this work on all devices? Yes.</li></ul><p>PausePaw can enforce a hard stop after your planned viewing time. Set it up on the <a href='/'>home page</a>.</p>",
    },
    zh: {
      title: "Netflix 自动连播：隐藏的屏幕时间杀手",
      desc: "Netflix 自动连播让你不知不觉继续看。这里教你怎么关掉它。",
      body: "<p>Netflix 自动连播是决定你观看会话何时结束的功能。</p><h2>自动连播的工作原理</h2><p>剧集结束时，Netflix 会自动播放下一集。</p><h2>为什么很难停下来</h2><ul><li>没有天然停顿</li><li>预览诱惑</li><li>承诺偏见</li></ul><h2>如何关闭</h2><p>进入账户 → 资料与 parental 控制 → 播放设置 → 自动播放下一集 → 关闭。</p><h2>常见问题</h2><ul><li>关掉自动连播会毁掉观看体验吗？不会。</li><li>这适用于所有设备吗？是的。</li></ul><p>PausePaw 可以在你计划的观看时间后强制执行停止。在<a href='/'>首页</a>设置。</p>",
    },
  },
