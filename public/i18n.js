...
window.I18N = {
  zh: {
    ...
    "bl_post8_t": "无手机小时：每天 1 小时会带来什么变化", "bl_post8_d": "每天留出 1 小时无手机时间，是最简单也最有效的数字健康习惯。这篇讲清楚为什么 1 小时就够，以及怎么开始。",
    "bl_post9_t": "屏幕时间 3-2-1 法则：睡前、醒后各一次", "bl_post9_d": "睡前 3 小时不碰工作消息，2 小时不碰娱乐内容，1 小时完全不碰手机。3-2-1 法则怎么落地，以及那些容易破功的坑。",
  ...
  en: {
    ...
    "bl_post6_t": "Screen Time and Sleep: The 90-Minute Rule That Works", "bl_post6_d": "Putting the phone down an hour before bed works better than any sleep app. The 90-minute rule gives your brain room to produce melatonin — no cold-turkey quitting required.",
    "bl_post7_t": "How Screen Time Affects Your Brain: The Dopamine Loop Explained", "bl_post7_d": "Why your phone is so hard to put down: the dopamine loop explained in plain English, plus three small habits that actually interrupt it.",
    "bl_post8_t": "Phone-Free Hours: How One Hour a Day Changes Everything", "bl_post8_d": "One phone-free hour a day is the simplest digital-health habit that actually sticks. Why an hour is enough, and how to start tomorrow.",
    "bl_post9_t": "The 3-2-1 Rule for Screen Time (Before Bed, After Waking)", "bl_post9_d": "No work messages 3 hours before bed, no entertainment 2 hours before, no phone at all 1 hour before. How the 3-2-1 rule sticks, and the mistakes that break it.",
