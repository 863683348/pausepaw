...
window.I18N = {
  zh: {
    ...
    "plan_month": "月", "plan_year": "年", "plan_subscribe": "订阅", "plan_current": "当前方案",
    "plan_toggle_month": "月付", "plan_toggle_year": "年付",
    "plan_popular": "最受欢迎",
    "plan_chars": "可领角色",
    "plan_hint": "免费版可领 1 个角色，会员解锁全部 5 个卡通伙伴。",
    "plan_active_hint": "感谢支持！会员权益已生效。",
    "plan_err": "发起订阅失败，请稍后再试",
    "plan_f_pro1": "全部核心防沉迷功能", "plan_f_pro2": "无限设备云端同步", "plan_f_pro3": "伙伴皮肤与陪伴模式",
    "plan_f_pro_chars": "全部 5 个角色随心切换（猫/机器猫/功夫熊猫/哪吒/敖润）",
    "plan_f_proy_chars": "全部 5 个角色随心切换",
    "plan_f_proy_save": "年付省 20%，相当于每月 $3.33",
    "plan_f_fam1": "含 5 个家庭成员席位", "plan_f_fam2": "家庭看板与周报", "plan_f_fam3": "儿童设备远程规则",
    "plan_f_fam_chars": "全部 5 个角色 + 家庭席位",
    "plan_char_preview": "套餐包含角色",
    "adopt_title": "领养你的伙伴",
    "adopt_hint_chars": "当前套餐最多可领 {n} 个，已领 {c} 个（免费仅 1 个，升级解锁全部）",
    "char_active": "使用中", "char_activated": "已设为休息陪伴",
    "char_claimed": "已拥有", "char_limit_reached": "免费版仅可领 1 个角色，升级会员解锁全部 5 个",
    "char_need_upgrade": "升级会员即可解锁全部角色",
    ...
    "pr_ad_h": "广告与个性化广告", "pr_ad_1": "本站在部分公开页面使用 Google AdSense 展示广告。AdSense 可能使用 Cookie（含个性化广告 Cookie）依据你过往访问行为投放更相关广告。你可通过 Google 广告设置（adssettings.google.com）或 YourOnlineChoices 管理或关闭个性化广告。",
    "pr_rights_h": "你的权利",
  ...
  en: {
    ...
    "plan_month": "mo", "plan_year": "yr", "plan_subscribe": "Subscribe", "plan_current": "Current plan",
    "plan_toggle_month": "Monthly", "plan_toggle_year": "Yearly",
    "plan_popular": "Most Popular",
    "plan_chars": "Characters",
    "plan_hint": "Free plan claims 1 character; membership unlocks all 5 cartoon companions.",
    ...
    "plan_f_pro_chars": "All 5 characters, switch freely (Cat / Doraemon / Kung Fu Panda / Nezha / Ao Run)",
    "plan_f_proy_chars": "All 5 characters, switch freely",
    "plan_f_proy_save": "Save 20% with yearly (~$3.33/mo)",
    "plan_f_fam1": "Up to 5 family seats", "plan_f_fam2": "Family dashboard & weekly report", "plan_f_fam3": "Remote rules for kids' devices",
    "plan_f_fam_chars": "All 5 characters + family seats",
    "plan_char_preview": "Included characters",
    "adopt_title": "Adopt your companion",
    "adopt_hint_chars": "Your plan allows up to {n} characters, {c} claimed (free = 1, upgrade for all 5).",
    "char_active": "Active", "char_activated": "Set as break companion",
    "char_claimed": "Owned", "char_limit_reached": "Free plan allows only 1 character. Upgrade to unlock all 5.",
    "char_need_upgrade": "Upgrade to unlock all characters",
    ...
    "pr_ad_h": "Advertising & personalization", "pr_ad_1": "Some public pages use Google AdSense to show ads. AdSense may use cookies (including for personalized advertising) to serve ads based on your prior visits. You can manage or opt out of personalized ads via Google Ads Settings (adssettings.google.com) or YourOnlineChoices.",
