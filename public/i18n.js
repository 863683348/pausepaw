...
window.I18N = {
  zh: {
    ...
    "bl_post14_t": "为什么一无聊就想摸手机？科学解释 + 两周替换计划", "bl_post14_d": "先承认一件事：我自己也没逃过。写稿卡壳，手就不自觉地伸向手机，解锁，滑两下，又锁屏。你问我看到了什么？什么都没记住。这就是 boredom phone use 最典型的场景——不是你想用手机，是无聊让你伸手。",
  ...
  en: {
    ...
    "bl_post14_t": "Why You Reach for Your Phone When You're Bored", "bl_post14_d": "I'll admit it, I haven't escaped this myself. Mid-sentence in an article, my hand wanders to the phone. Unlock. Scroll. Lock. What did I see? I couldn't tell you. That's the classic boredom phone use scene. It's not that you want the phone. It's that boredom makes your hand move.",
