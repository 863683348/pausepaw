...
window.I18N = {
  zh: {
    ...
    "bl_post13_t": "12 个迹象说明你手机成瘾了", "bl_post13_d": "多数人要等出了事才注意到手机成瘾的迹象：错过截止、脖子僵硬、孩子问你为什么总看屏幕。这里列了 12 个信号，以及真正有用的做法。", "bl_post12_t": "10 分钟自检你的屏幕时间", "bl_post12_d": "不用装任何 App，只用手机自带的屏幕时间功能，十分钟就能完成一次 screen time audit。这篇是完整的操作步骤：查哪些数据、怎么看懂、以及看完之后该做哪三件事。", "bl_post11_t": "工作屏幕时间：多少算正常，多少算倦怠", "bl_post11_d": "工作屏幕时间是大多数成年人一天里占比最大的屏幕时段。这篇给你一套实测过的清单，帮你分辨高效深工作和屏幕导致的倦怠。", "bl_post10_t": "屏幕时间 vs 屏幕质量：关键不是小时数", "bl_post10_d": "两小时专注工作，比六小时无意识刷屏更有价值——但屏幕时间统计把两者混在一起。这篇教你怎么区分 quality screen time，以及怎么让屏幕时间变\"贵\"。",
  ...
  en: {
    ...
    "bl_post13_t": "12 Signs You're Addicted to Your Phone", "bl_post13_d": "Phone addiction signs are rarely dramatic — missed deadlines, stiff necks, kids asking why you never look up. Here are 12 signals to check, plus what actually works.", "bl_post12_t": "How to Audit Your Own Screen Time in 10 Minutes", "bl_post12_d": "No extra apps needed: use the screen time tools built into your phone to run a full audit in ten minutes. Here is the exact workflow, which numbers matter, and the three actions that follow.", "bl_post11_t": "Workplace Screen Time: What's Normal and What's Burnout", "bl_post11_d": "Work screen time is the biggest slice of screen time in most adults' lives. This post gives you a field-tested checklist that separates productive deep work from screen-induced burnout.", "bl_post10_t": "Screen Time vs. Screen Quality: It's Not the Hours, It's the Content", "bl_post10_d": "Two hours of focused work beats six hours of mindless scrolling, yet the stats lump them together. This post shows how to spot quality screen time and make your screen time count.",
